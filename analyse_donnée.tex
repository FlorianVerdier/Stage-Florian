...
ylabel={Densité},
ylabel style={xshift=+9pt},
xlabel={Temps de Trajet (en heure)},
xlabel style={xshift=+9pt},
width=\linewidth,height=\linewidth
]
...
Les données disposent d'un champ \emph{date d'inscription} correspondant en théorie à la date à laquelle l'usager à réservé un créneau. Cependant, cette date ne correspond généralement pas à la date d'inscription réelle mais à la date de dernière action sur la réservation, que ce soit son annulation, sa modification ou bien un retour anticipé de la voiture. Ainsi les données ne sont pas forcément fiables et sont donc difficiles à exploiter.
